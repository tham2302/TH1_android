...
import com.lesson8.de_2_final_crud.R;

import java.util.ArrayList;
import java.util.List;

public class BookAdapter extends RecyclerView.Adapter<com.lesson8.de_2_final_crud.model.BookAdapter.BookViewHolder> {
