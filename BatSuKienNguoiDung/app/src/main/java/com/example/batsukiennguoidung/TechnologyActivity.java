...
import com.example.batsukiennguoidung.model.Technology;
import com.example.batsukiennguoidung.model.TechnologyAdapter;
...
public class TechnologyActivity extends AppCompatActivity {
    ...
    private void initData() {
        Integer[] imgs={R.drawable.img_1, R.drawable.img_2, R.drawable.img_4, R.drawable.img_3};
        String[] names={"Android", "Ios", "Blackberry", "Window Mobile"};
        String[] subs={"Sub Android", "Sub Ios", "Sub Blackberry", "Sub Window Mobile"};
        String[] describes={"MT Android", "MT Ios", "MT Blackberry", "MT Window Mobile"};
